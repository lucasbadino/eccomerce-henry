...
let Orders = class Orders {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String, default: (0, uuid_1.v4)() }, user: { required: true, type: () => require("../users/users.entity").Users }, date: { required: true, type: () => Date }, orderDetail: { required: true, type: () => require("../ordersDetails/orderDetails.entity").OrderDetails } };
    }
};
