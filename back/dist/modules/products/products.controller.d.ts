...
export declare class ProductController {
    ...
    getProducts(res: Response, limit?: number, page?: number): Promise<Response<any, Record<string, any>>>;
    getProductsById(id: string, res: Response): Promise<Response<any, Record<string, any>>>;
